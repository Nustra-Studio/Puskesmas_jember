...
class Kasus extends ResourceController
{
    ...
    {
        $this->model = new KasusModel();
        $this->namepage =[
			'title_meta' => view('partials/title-meta', ['title' => 'Master Data Kasus']),
			'page_title' => view('partials/page-title', ['title' => 'Masterdata Kasus'])
		];
    }
    public function index()
    {

		return view('datamaster/Kasus', $this->namepage);
    }
    ...
    public function create()
    {
        ...
        return redirect()->to(site_url('/kasus'))
