...
class Tindakan extends ResourceController
{
    ...
    {
        $this->model = new TindakanModel();
        $this->namepage =[
			'title_meta' => view('partials/title-meta', ['title' => 'Master Data Tindakan']),
			'page_title' => view('partials/page-title', ['title' => 'Masterdata Tindakan'])
		];
    }
    public function index()
    {

		return view('datamaster/Tindakan', $this->namepage);
    }
    ...
    public function create()
    {
        ...
        return redirect()->to(site_url('/tindakan'))
