...
<?= $this->include('partials/body') ?>
    ...
    <div class="main-content">
        ...
        <div class="page-content">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="mt-2">
                                                                    <form action="<?=site_url("tindakan/update/{$item['id']}")?>" method="post" enctype="multipart/form-data">
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div class="mb-3">
                                                                                    <label class="form-label" for="formrow-email-input">Kode Tindakan</label>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div class="mb-3">
                                                                                    <label class="form-label" for="formrow-email-input">Nama Tindakan</label>
            ...
            <?= $this->include('datamaster/addon/tindakan/ModalCreate') ?>
            </div> <!-- container-fluid -->
        </div>
        <!-- End Page-content -->
<!--  Large modal example -->
