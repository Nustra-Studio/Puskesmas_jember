                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="agama" id="agama" class="form-select">
                                                <?php foreach ($agama as $unit) : ?>
                                                    <option <?= ($item['agama'] === $unit['name']) ? 'selected' : '' ?> value="<?= $unit['name'] ?>"><?= $unit['name'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="gol_darah" id="agama" class="form-select">
                                                <?php foreach ($darah as $unit) : ?>
                                                    <option <?= ($item['gol_darah'] === $unit['name']) ? 'selected' : '' ?> value="<?= $unit['name'] ?>"><?= $unit['name'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="pendidikan" id="pendidikan" class="form-select">
                                                <?php foreach ($pendidikan as $unit) : ?>
                                                    <option <?= ($item['pendidikan'] === $unit['name']) ? 'selected' : '' ?> value="<?= $unit['name'] ?>"><?= $unit['name'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="category" id="kelamin" class="form-select">
                                                <option <?= ($item['category'] === 'Kritis') ? 'selected' : '' ?> value="Kritis">Kritis</option>
                                                <option <?= ($item['category'] === 'Normal') ? 'selected' : '' ?> value="Normal">Normal</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="payment" id="kelamin" class="form-select">
                                                <option <?= ($item['payment'] === 'Cash') ? 'selected' : '' ?> value="Cash">Cash</option>
                                                <option <?= ($item['payment'] === 'Transfer') ? 'selected' : '' ?> value="Transfer">Transfer</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="poli" id="kelamin" class="form-select">
                                                <option <?= ($item['poli'] === '1') ? 'selected' : '' ?> value="1">1</option>
                                                <option <?= ($item['poli'] === '2') ? 'selected' : '' ?> value="2">2</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
